...
const runId = String(process.env.WAVE_B_RUN_ID || "b1-c17-r1-v100");
...
const sessionAcquireCount = Number(sessionStore?.acquire?.count || 0);
...
const summary = {
  ...
  poolDemand: {
    totalProfileSeconds,
    sessionStoreAcquireCount: sessionAcquireCount,
    sessionStoreAcquirePerSecondWholeProfile: totalProfileSeconds > 0 ? sessionAcquireCount / totalProfileSeconds : null,
    ...
    totalHttpRequestsPerSessionStoreAcquire: sessionAcquireCount > 0 ? totalHttpRequests / sessionAcquireCount : null,
    steadyOperationsPerSessionStoreAcquire: sessionAcquireCount > 0 ? steadyOperations / sessionAcquireCount : null,
  },
...
console.log("B1_C17_CONTROL_SUMMARY_BEGIN");
console.log(JSON.stringify(summary, null, 2));
console.log("B1_C17_CONTROL_SUMMARY_END");
