...
export class MfaService {
  ...
  async initialize(){await this.pool.query(`SELECT user_id,kind,secret_iv,secret_tag,secret_ciphertext,enabled,created_at,verified_at FROM gracz_mfa LIMIT 0`);}
