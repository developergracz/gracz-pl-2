...
import { PostgresGomokuService } from "./postgres-gomoku-service.js";
...
const gomokuService=config.databaseUrl?new PostgresGomokuService(config.databaseUrl):new GomokuService();if(gomokuService.ready)await gomokuService.ready;const gomokuHandler=createGomokuHttpHandler({service:gomokuService,auth,authSessions});
