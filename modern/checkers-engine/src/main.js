...
const lobbyAuthScriptHash="'sha256-ay1CttFvNbk4oIadWoLhdDkjpCH78/6U7ZdqhX3FI98='";
const scriptSrc=turnstileEnabled?`'self' ${lobbyAuthScriptHash} ${turnstileOrigin}`:`'self' ${lobbyAuthScriptHash}`;
