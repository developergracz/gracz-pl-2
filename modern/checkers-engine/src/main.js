...
const server=createGameHttpServer({store,accounts,authSessions,messageAttachments,auth,lobby,webRoot,logger:secureLogger(audit),realtime:checkersRealtime||undefined});
