...
const newsletter=new NewsletterService(config.databaseUrl||null,{mail});await newsletter.ready;const newsletterHandler=createNewsletterHandler(newsletter,{security,monitor});
const newsletterAdmin=new NewsletterAdminService(config.databaseUrl||null);await newsletterAdmin.ready;const newsletterAdminHandler=createNewsletterAdminHandler({service:newsletterAdmin,auth,authSessions,rbac,mfa,audit,security});
