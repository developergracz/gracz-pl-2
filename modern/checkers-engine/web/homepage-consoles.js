(() => {
  ...
  @media(max-width:900px){.classic-home-console{grid-template-columns:1.2fr .8fr}.classic-home-boardwrap{padding:5px}.classic-table{font-size:10px}.classic-chat{min-height:48px}.gomoku-console-home .classic-chat{min-height:0}}
  `;
