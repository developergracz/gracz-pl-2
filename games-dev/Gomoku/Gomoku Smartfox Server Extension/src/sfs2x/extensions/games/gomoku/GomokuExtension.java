...
public class GomokuExtension extends SFSExtension implements IGeneralRoomOptions {
	private GomokuGameBoard gameBoard;
	...
	public void init() {
		...
		moveCount = 0;
		gameBoard = new GomokuGameBoard(this);
	...
	// Changed to public by £ukasz Wyporek, 19.03.2015
	...
	// Added by £ukasz Wyporek, 15.10.2014
	void setGameplayId(long database_id_gameplay)
	{
