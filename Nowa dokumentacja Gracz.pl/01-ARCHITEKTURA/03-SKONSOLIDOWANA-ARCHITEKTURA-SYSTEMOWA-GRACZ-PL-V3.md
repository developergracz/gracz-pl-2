...
| [`ADR-V3-012`](../09-DECYZJE-ARCHITEKTONICZNE/ADR-V3-012-DATA-RETENTION-PRIVACY-DELETION-LEGAL-HOLD.md) | P0 | retencja, privacy deletion i legal hold | przed `REVIEWED DESIGN` | `DESIGN COMPLETE / ARCHITECTURE PASS / REVIEW PACK READY / FORMAL PRIVACY-LEGAL REVIEW PENDING / NOT IMPLEMENTED` |
