...
| PL-E07-P03 | **Resend Email API** | rejestracja, recovery, newsletter, delivery telemetry | e-mail, token delivery metadata, campaign/lifecycle data | `PROCESSOR MODEL PUBLICLY VERIFIED / ACCOUNT SCOPE OPEN` | `USA / GLOBAL SUBPROCESSORS / CONDITIONAL` | `PUBLIC DPA VERIFIED / ACCOUNT-EFFECTIVE DPA PENDING` | `PUBLIC REGISTER VERIFIED / ACCOUNT APPLICABILITY OPEN` | `INTEGRATED IN CODE / ACCOUNT APPROVAL OR ACCOUNT-SPECIFIC EVIDENCE PENDING` |
...
| PL-E07-P07 | **Cloudflare Turnstile** | ochrona formularzy i nadużyć | token challenge, IP/remoteip, UA/browser/security signals, hostname/origin | `SERVICE-SPECIFIC PROCESSOR MODEL / ACCOUNT SCOPE OPEN` | `GLOBAL / NOT EU-ONLY / CONDITIONAL` | `PUBLIC DPA VERIFIED / ACCOUNT-EFFECTIVE EVIDENCE PENDING` | `PUBLIC REGISTER VERIFIED / APPLICABILITY OPEN` | `INTEGRATED IN CODE / ACCOUNT APPROVAL OR ACCOUNT-SPECIFIC EVIDENCE PENDING` |
